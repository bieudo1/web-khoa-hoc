...
function slider() {
  ...
  var wrap_slider = document.getElementById("wrap-slider").offsetWidth;
  var endposConstant = (wrap_slider <= 544 && 28) || (wrap_slider <= 736 && 27) || 25;
  ...
  for (var i = 0; i < box_arr.length; i++) {
    if (box_arr[i].className == "slide-box") {
      box_quantity++;
      box_width = box_arr[i].offsetWidth + 120;
    }
  }
